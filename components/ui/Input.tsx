    ...
    return (
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          id={inputId}
          className={cn(
            'w-full h-14 rounded-2xl bg-c-input border border-c-border-input px-5 text-base text-c-text placeholder:text-c-text-5',
            'focus:outline-none focus:border-accent-secondary/70 focus:ring-2 focus:ring-accent-secondary/20',
            'transition-colors',
