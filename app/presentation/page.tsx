...
const PHASES = [
  {
    ...
    icon: ClipboardList,
    color: 'from-[#fb8e28]/20 to-[#fb8e28]/5',
    border: 'border-[#fb8e28]/30',
    text: 'text-[#fb8e28]',
    accent: '#fb8e28',
...
function StatCard({ value, label }: { value: string; label: string }) {
  return (
    <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-5 text-center">
      <div className="text-3xl font-bold text-[#fb8e28] mb-1">{value}</div>
          ...
          >
              ...
              <div className="h-full flex flex-col items-center justify-center text-center px-12 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl">
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }}>
                    <div className="inline-flex items-center gap-2 bg-[#fb8e28]/10 border border-[#fb8e28]/25 text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase px-4 py-2 rounded-full mb-8">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#fb8e28]" />
                  ...
                  <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 0.65 }}
                    ...
                    Your Home.<br />
                    <span className="text-[#fb8e28]">Protected &amp; Beautiful.</span>
                  </motion.h1>
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7, duration: 0.6 }}
                    ...
                    {[
                      ...
                      <div key={label} className="flex items-center gap-2">
                        <Icon className="w-4 h-4 text-[#fb8e28]" />
                        {label}
                      </div>
                    ))}
                  </motion.div>
            ...
            {currentSlide === 'about' && (
              <div className="h-full grid grid-cols-2">
                ...
                <div className="flex flex-col justify-center px-14 py-12 bg-[#0a0a0a]">
                  <div className="text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase mb-3">Who We Are</div>
            ...
            {currentSlide === 'why-us' && (
              <div className="h-full flex flex-col items-center justify-center px-16 relative overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-4xl mt-6">
                  <div className="text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase mb-3">The Patriot Difference</div>
            ...
            {currentSlide === 'portfolio' && (
              <div className="h-full flex flex-col px-12 py-8">
                <div className="text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase mb-2">Our Work</div>
            ...
            {currentSlide === 'journey' && (
              <div className="h-full flex flex-col items-center justify-center px-16"
                style={{ background: 'radial-gradient(ellipse at 70% 50%, rgba(251,142,40,0.05) 0%, transparent 60%)' }}>
                <div className="w-full max-w-5xl">
                  <div className="text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase mb-3">Your Roofing Project</div>
            ...
            {currentSlide === 'investment' && quote && (
              <div className="h-full flex flex-col items-center justify-center px-12"
                style={{ background: 'radial-gradient(ellipse at 50% 40%, rgba(251,142,40,0.07) 0%, transparent 65%)' }}>
                <div className="w-full max-w-3xl">
                  <div className="text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase mb-2">Your Investment</div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-5">
                        ...
                        {quote.projectTypes.map(pt => (
                          <div key={pt} className="flex items-center gap-2.5 text-sm text-white/75 mb-2">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#fb8e28] shrink-0" />
                      ...
                      <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-5">
                        ...
                        <div className="space-y-2 text-sm text-white/55">
                          ...
                          {quote.siteConditions.tearOff && <div className="text-[#fb8e28]/70">Includes tear-off{quote.siteConditions.layers && quote.siteConditions.layers > 1 ? ` (${quote.siteConditions.layers} layers)` : ''}</div>}
                        </div>
                      </div>
                      {/* Warranty badge */}
                      <div className="bg-[#fb8e28]/8 border border-[#fb8e28]/25 rounded-2xl p-4 flex items-center gap-3">
                        <BadgeCheck className="w-5 h-5 text-[#fb8e28] shrink-0" />
                        <div>
                          <div className="text-xs font-semibold text-[#fb8e28]">Workmanship Guarantee</div>
                    ...
                    <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-7 flex flex-col justify-between">
                      ...
                      <div className="mt-6 pt-6 border-t border-white/[0.08]">
                        ...
                        <div className="text-6xl font-bold text-[#fb8e28] leading-none mb-3">{formatCurrency(quote.total)}</div>
            ...
            {currentSlide === 'financing' && quote && (
              <div className="h-full flex flex-col items-center justify-center px-12">
                <div className="w-full max-w-2xl">
                  <div className="text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase mb-2">Flexible Options</div>
                    ...
                    {settings.financing.map((opt, i) => (
                      <button key={opt.id} onClick={() => setSelectedTerm(i)}
                        className={cn('flex-1 py-3 rounded-xl text-sm font-semibold transition-all cursor-pointer',
                          selectedTerm === i ? 'bg-[#fb8e28] text-black shadow-lg shadow-[#fb8e28]/25' : 'text-white/35 active:bg-white/5'
                        )}>
                        {opt.label}
                      </button>
                    ))}
                  ...
                  {financing && (
                    <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8">
                      <div className="grid grid-cols-3 gap-8 text-center mb-6">
                        <div>
                          <div className="text-5xl font-bold text-[#fb8e28] mb-2">{formatCurrency(financing.monthlyPayment)}</div>
              ...
              <div className="h-full flex flex-col items-center justify-center text-center px-12 relative overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-3xl">
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
                    <div className="inline-flex items-center gap-2 bg-[#fb8e28]/10 border border-[#fb8e28]/25 text-[#fb8e28] text-[11px] font-bold tracking-widest uppercase px-4 py-2 rounded-full mb-6">
                  ...
                  <motion.h2 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }}
                    ...
                    <span className="text-[#fb8e28]">For Years to Come</span>
                  </motion.h2>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-10 text-left">
                    {[
                      ...
                      <motion.div key={s.step}
                        ...
                        <div className="text-3xl font-bold text-[#fb8e28]/25 mb-3">{s.step}</div>
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.85 }}
                    ...
                    <div className="flex items-center gap-2">
                      <Phone className="w-4 h-4 text-[#fb8e28]/70" />
          ...
          {Array.from({ length: totalSlides }).map((_, i) => (
            ...
            >
              <div className={cn('rounded-full transition-all',
                i === slide ? 'w-5 h-2 bg-[#fb8e28]' : 'w-2 h-2 bg-white/[0.12]'
              )} />
            </button>
          ))}
        </div>
